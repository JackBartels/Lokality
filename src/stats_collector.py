...
from utils import debug_print, get_system_resources

client = ollama.Client()

class StatsCollector:
    """
    Gathers and processes system and model performance metrics.
    """
    @staticmethod
    ...
    def get_model_info(memory_store, system_prompt, messages):
        ...
        try:
            StatsCollector._get_resource_usage(stats)
    ...
    def get_system_stats():
        """Returns raw system resource information."""
        ram, vram = get_system_resources()
        return {"total_ram": ram, "total_vram": vram}
