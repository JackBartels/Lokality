...
class TestComplexityScorer(unittest.TestCase):
    def setUp(self):
        ...
        self.size_patcher = patch('complexity_scorer.ComplexityScorer._get_loaded_model_size_mb')
    ...
    def test_moderate_question(self):
        ...
        text = "I would like to know what is the capital of France and what is the population there."
    ...
    def test_true_moderate(self):
        ...
        text = "Can you write a short story about a robot? Please include some details about its internal class structure."
        res = ComplexityScorer.analyze(text)
        self.assertEqual(res['level'], ComplexityScorer.LEVEL_MODERATE)
        self.assertGreaterEqual(res['params']['num_ctx'], 2048)
